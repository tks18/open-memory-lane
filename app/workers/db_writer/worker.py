...
class DBWriter(threading.Thread):
    ...
    def stop(self):
        """
        Stop the worker gracefully. This will flush any remaining items in the queue and set the `stop_event`.
        It is called when the application is shutting down to ensure that the worker thread exits cleanly.
        """
        self.stop_event.set()
